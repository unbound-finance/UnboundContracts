...
contract TestUSDC is IERC20 {
    ...
    constructor(address tester) {
        balanceOf[msg.sender] = balanceOf[msg.sender].add(100000000 * (10 ** decimals));
        balanceOf[tester] = balanceOf[tester].add(100000000 * (10 ** decimals));
        totalSupply = totalSupply.add(200000000 * (10 ** decimals));
    }
